jQuery(document).ready(function() {
  ...
  // HAMBURGER
  jQuery('.jsHamburgerOpen').on('click', function(e) {
    e.preventDefault();
    jQuery('body').addClass('has-hamburger-menu-visible');
  });

  jQuery('.jsHamburgerClose').on('click', function(e) {
    e.preventDefault();
    jQuery('body').removeClass('has-hamburger-menu-visible');
  });
	...
	var toggleLink = jQuery('#comments-button');

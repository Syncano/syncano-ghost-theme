...
jQuery(document).ready(function(){"use strict";function e(){0==$(".pagination a").length&&$(".pagination").hide()}function t(){$("pre code").each(function(e){"undefined"!=typeof jQuery(this).attr("data-language")&&0!=jQuery(this).attr("data-language")||jQuery(this).attr("data-language","generic")}),1==config.highlightcode&&Rainbow.color()}function o(){0==config.show_ecko_disclaimer&&jQuery(".copyright .ecko").hide()}function n(){jQuery(".postcontents, .format-video, .format-audio").fitVids()}function i(){""!=config.disqus_shortname&&null!=config.disqus_shortname&&void 0!=config.disqus_shortname&&jQuery(".commentitems").length>0&&(0==config.autoload_comments?(jQuery(".commenttitle").text("View Comments"),jQuery(".commentitems").hide()):a())}function a(){if(""!=config.disqus_shortname){var e=config.disqus_shortname;!function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="//"+e+".disqus.com/embed.js",(document.getElementsByTagName("head")[0]||document.getElementsByTagName("body")[0]).appendChild(t)}()}}function r(){""!=config.analytics_id&&null!=config.analytics_id&&void 0!=config.analytics_id&&(!function(e,t,o,n,i,a,r){e.GoogleAnalyticsObject=i,e[i]=e[i]||function(){(e[i].q=e[i].q||[]).push(arguments)},e[i].l=1*new Date,a=t.createElement(o),r=t.getElementsByTagName(o)[0],a.async=1,a.src=n,r.parentNode.insertBefore(a,r)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create",config.analytics_id,"auto"),ga("send","pageview"))}function u(){jQuery("img").attr("data-no-retina","true"),jQuery("img.retina").removeAttr("data-no-retina","false")}function c(){jQuery("body.post-template .subtitle").length>0&&jQuery(".posttitle .excerpt").text(jQuery("body.post-template .subtitle").text())}function s(){if(jQuery(".cover").length>0&&(jQuery("footer.postinfo").css("display","none"),jQuery(".cover").waypoint(function(e){"down"==e&&jQuery("footer.postinfo").css("display","block"),"up"==e&&jQuery("footer.postinfo").fadeOut(200)},{offset:-75})),jQuery(".headroom").length>0){var e=document.querySelector(".headroom"),t=new Headroom(e);t.init()}}function l(){jQuery("input.email").attr("placeholder","Email")}function y(){if(jQuery("body.post-template").length>0&&jQuery(window).width()>880&&"0.3"==jQuery(".cover").attr("data-opacity")){var e=jQuery(".cover"),t=jQuery(".cover").height();jQuery(window).resize(function(){e=jQuery(".cover"),t=jQuery(".cover").height()}),jQuery(window).on("scroll",function(){var o=jQuery(this).scrollTop();e.each(function(){var e=jQuery(this).offset().top,n=jQuery(this).outerHeight();e+=n/1,jQuery(".cover .background").css({opacity:.3+(o-e+t)/(t/2)}),jQuery(".cover .posttitle").css({opacity:1-(o-e+t)/(t/1.5)})})})}}function d(){if(navigator.userAgent.match(/(iPad|iPhone);.*CPU.*OS 7_\d/i)){var e=Math.floor(jQuery(window).height()*(jQuery(".cover").attr("data-height")/100));jQuery(".cover").css("height",e)}}function f(){jQuery(".postcontents p").has('img[alt="full"]').each(function(){jQuery(this).addClass("full")}),jQuery(".postcontents p").has('img[alt="wide"]').each(function(){jQuery(this).addClass("wide")})}!function(){u(),e(),t(),o(),n(),i(),r(),c(),l(),s(),y(),f()}(),jQuery(".commentheader, .showcomments").click(function(){jQuery(".commentitems").slideDown(500),jQuery(".commenttitle").html("Comments"),jQuery(".commentheader").css("cursor","default"),jQuery("html, body").animate({scrollTop:jQuery("#comments").offset().top},800),a()}),jQuery(".showsearch").click(function(){jQuery(".searchoverlay").fadeIn(500),jQuery(".searchoverlay .query").focus()}),jQuery(".closesearch").click(function(){jQuery(".searchoverlay").fadeOut(500)}),jQuery(".searchform .submit").click(function(){jQuery(this).parent("form").submit()}),jQuery(".jsHamburgerOpen").on("click",function(e){e.preventDefault(),jQuery("body").addClass("has-hamburger-menu-visible")}),jQuery(".jsHamburgerClose").on("click",function(e){e.preventDefault(),jQuery("body").removeClass("has-hamburger-menu-visible")}),FastClick.attach(document.body),jQuery(".widget.navigation > ul > li.menu-item-has-children > a, nav.main li.menu-item-has-children > a").each(function(){jQuery(this).html(jQuery(this).text()+'<i class="fa fa-chevron-down"></i>')}),jQuery(".drawer li.menu-item-has-children > a").on("click",function(){var e=jQuery(this).parent();return jQuery("a i",e).toggleClass("fa-chevron-down"),jQuery("a i",e).toggleClass("fa-chevron-up"),jQuery(".sub-menu",e).slideToggle(),!1}),jQuery("li.menu-item-has-children > a").on("click",function(){if("#"==jQuery(this).attr("href"))return!1}),jQuery(".mouse").click(function(){jQuery("html, body").animate({scrollTop:jQuery(".cover").height()},1e3)}),jQuery(".backtotop").click(function(){jQuery("html, body").animate({scrollTop:0},600)}),jQuery(".postbottom").waypoint(function(e){"down"==e&&jQuery(".default").fadeOut(200,function(){jQuery(".postinfo .relatedposts").fadeIn(200)}),"up"==e&&jQuery(".postinfo .relatedposts").fadeOut(200,function(){jQuery(".default").fadeIn(200)})},{offset:"100%"}),jQuery(".showsocial").click(function(){jQuery("footer.postinfo .socialoptions").fadeToggle(200)}),jQuery(".closeshare").click(function(){jQuery("footer.postinfo .socialoptions").fadeOut(200)}),navigator.userAgent.match(/(iPad|iPhone);.*CPU.*OS 7_\d/i)&&(d(),jQuery(window).resize(function(){d()})),jQuery(".postcontents a").has("img").magnificPopup({type:"image",closeOnContentClick:!0,fixedContentPos:!0,mainClass:"mfp-no-margins mfp-with-zoom",image:{verticalFit:!0},gallery:{enabled:!0},zoom:{enabled:!0,duration:300}}),jQuery(".eckogallery, .gallery").each(function(){jQuery(this).magnificPopup({delegate:"a",type:"image",mainClass:"mfp-no-margins mfp-with-zoom",gallery:{enabled:!0},image:{verticalFit:!0},zoom:{enabled:!0,duration:300}})});var m=jQuery("#disqus_thread"),h=jQuery("#comments-button");m.toggle(),h.click(function(){DISQUS.reset({reload:!0}),m.toggle(),h.css({display:"none"})})});